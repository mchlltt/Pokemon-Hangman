...
var pokeData = [
	{id: 1,name: 'bulbasaur',type: 'poison, grass'},
	{id: 2,name: 'ivysaur',type: 'poison, grass'},
	{id: 3,name: 'venusaur',type: 'poison, grass'},
	...
	{id: 12,name: 'butterfree',type: 'flying, bug'},
	{id: 13,name: 'weedle',type: 'poison, bug'},
	{id: 14,name: 'kakuna',type: 'poison, bug'},
	{id: 15,name: 'beedrill',type: 'poison, bug'},
	...
	{id: 41,name: 'zubat',type: 'flying, poison'},
	{id: 42,name: 'golbat',type: 'flying, poison'},
	...
	{id: 48,name: 'venonat',type: 'poison, bug'},
	{id: 49,name: 'venomoth',type: 'poison, bug'},
	...
	{id: 62,name: 'poliwrath',type: 'fighting, water'},
	...
	{id: 69,name: 'bellsprout',type: 'poison, grass'},
	{id: 70,name: 'weepinbell',type: 'poison, grass'},
	{id: 71,name: 'victreebel',type: 'poison, grass'},
	{id: 72,name: 'tentacool',type: 'poison, water'},
	{id: 73,name: 'tentacruel',type: 'poison, water'},
	...
	{id: 81,name: 'magnemite',type: 'steel, electric'},
	{id: 82,name: 'magneton',type: 'steel, electric'},
	{id: 83,name: 'farfetchd',type: 'normal, flying'},
	...
	{id: 92,name: 'gastly',type: 'poison, ghost'},
	{id: 93,name: 'haunter',type: 'poison, ghost'},
	{id: 94,name: 'gengar',type: 'poison, ghost'},
	{id: 95,name: 'onix',type: 'ground, rock'},
	...
	{id: 123,name: 'scyther',type: 'flying, bug'},
	{id: 124,name: 'jynx',type: 'psychic, ice'},
	...
	{id: 130,name: 'gyarados',type: 'flying, water'},
	...
	{id: 142,name: 'aerodactyl',type: 'flying, rock'},
	{id: 143,name: 'snorlax',type: 'normal'},
	{id: 144,name: 'articuno',type: 'flying, ice'},
	{id: 145,name: 'zapdos',type: 'flying, electric'},
	{id: 146,name: 'moltres',type: 'flying, fire'},
	{id: 147,name: 'dratini',type: 'dragon'},
	{id: 148,name: 'dragonair',type: 'dragon'},
	{id: 149,name: 'dragonite',type: 'flying, dragon'},
	...
	{id: 165,name: 'ledyba',type: 'flying, bug'},
	{id: 166,name: 'ledian',type: 'flying, bug'},
	{id: 167,name: 'spinarak',type: 'poison, bug'},
	{id: 168,name: 'ariados',type: 'poison, bug'},
	{id: 169,name: 'crobat',type: 'flying, poison'},
	...
	{id: 176,name: 'togetic',type: 'flying, fairy'},
	{id: 177,name: 'natu',type: 'flying, psychic'},
	{id: 178,name: 'xatu',type: 'flying, psychic'},
	...
	{id: 187,name: 'hoppip',type: 'flying, grass'},
	{id: 188,name: 'skiploom',type: 'flying, grass'},
	...
	{id: 193,name: 'yanma',type: 'flying, bug'},
	{id: 194,name: 'wooper',type: 'ground, water'},
	{id: 195,name: 'quagsire',type: 'ground, water'},
	{id: 196,name: 'espeon',type: 'psychic'},
	{id: 197,name: 'umbreon',type: 'dark'},
	{id: 198,name: 'murkrow',type: 'flying, dark'},
	...
	{id: 207,name: 'gligar',type: 'flying, ground'},
	{id: 208,name: 'steelix',type: 'ground, steel'},
	{id: 209,name: 'snubbull',type: 'fairy'},
	{id: 210,name: 'granbull',type: 'fairy'},
	{id: 211,name: 'qwilfish',type: 'poison, water'},
	{id: 212,name: 'scizor',type: 'bug, steel'},
	{id: 213,name: 'shuckle',type: 'rock, bug'},
	{id: 214,name: 'heracross',type: 'fighting, bug'},
	{id: 215,name: 'sneasel',type: 'ice, dark'},
	{id: 216,name: 'teddiursa',type: 'normal'},
	{id: 217,name: 'ursaring',type: 'normal'},
	{id: 218,name: 'slugma',type: 'fire'},
	{id: 219,name: 'magcargo',type: 'rock, fire'},
	{id: 220,name: 'swinub',type: 'ground, ice'},
	{id: 221,name: 'piloswine',type: 'ground, ice'},
	{id: 222,name: 'corsola',type: 'rock, water'},
	{id: 223,name: 'remoraid',type: 'water'},
	{id: 224,name: 'octillery',type: 'water'},
	{id: 225,name: 'delibird',type: 'flying, ice'},
	{id: 226,name: 'mantine',type: 'flying, water'},
	{id: 227,name: 'skarmory',type: 'flying, steel'},
	{id: 228,name: 'houndour',type: 'fire, dark'},
	{id: 229,name: 'houndoom',type: 'fire, dark'},
	...
	{id: 238,name: 'smoochum',type: 'psychic, ice'},
	...
	{id: 246,name: 'larvitar',type: 'ground, rock'},
	{id: 247,name: 'pupitar',type: 'ground, rock'},
	{id: 248,name: 'tyranitar',type: 'rock, dark'},
	{id: 249,name: 'lugia',type: 'flying, psychic'},
	{id: 251,name: 'celebi',type: 'grass, psychic'},
	{id: 252,name: 'treecko',type: 'grass'},
	{id: 253,name: 'grovyle',type: 'grass'},
	{id: 254,name: 'sceptile',type: 'grass'},
	{id: 255,name: 'torchic',type: 'fire'},
	{id: 256,name: 'combusken',type: 'fighting, fire'},
	{id: 257,name: 'blaziken',type: 'fighting, fire'},
	{id: 258,name: 'mudkip',type: 'water'},
	{id: 259,name: 'marshtomp',type: 'ground, water'},
	{id: 260,name: 'swampert',type: 'ground, water'},
	...
	{id: 267,name: 'beautifly',type: 'flying, bug'},
	{id: 268,name: 'cascoon',type: 'bug'},
	{id: 269,name: 'dustox',type: 'poison, bug'},
	...
	{id: 278,name: 'wingull',type: 'flying, water'},
	{id: 279,name: 'pelipper',type: 'flying, water'},
	...
	{id: 284,name: 'masquerain',type: 'flying, bug'},
	{id: 285,name: 'shroomish',type: 'grass'},
	{id: 286,name: 'breloom',type: 'fighting, grass'},
	{id: 287,name: 'slakoth',type: 'normal'},
	{id: 288,name: 'vigoroth',type: 'normal'},
	{id: 289,name: 'slaking',type: 'normal'},
	{id: 290,name: 'nincada',type: 'ground, bug'},
	{id: 291,name: 'ninjask',type: 'flying, bug'},
	...
	{id: 302,name: 'sableye',type: 'ghost, dark'},
	{id: 303,name: 'mawile',type: 'steel, fairy'},
	{id: 304,name: 'aron',type: 'rock, steel'},
	{id: 305,name: 'lairon',type: 'rock, steel'},
	{id: 306,name: 'aggron',type: 'rock, steel'},
	...
	{id: 315,name: 'roselia',type: 'poison, grass'},
	...
	{id: 322,name: 'numel',type: 'ground, fire'},
	{id: 323,name: 'camerupt',type: 'ground, fire'},
	...
	{id: 334,name: 'altaria',type: 'flying, dragon'},
	...
	{id: 339,name: 'barboach',type: 'ground, water'},
	{id: 340,name: 'whiscash',type: 'ground, water'},
	...
	{id: 357,name: 'tropius',type: 'flying, grass'},
	...
	{id: 380,name: 'latias',type: 'psychic, dragon'},
	{id: 381,name: 'latios',type: 'psychic, dragon'},
	{id: 382,name: 'kyogre',type: 'water'},
	{id: 383,name: 'groudon',type: 'ground'},
	{id: 384,name: 'rayquaza',type: 'flying, dragon'},
	{id: 385,name: 'jirachi',type: 'steel, psychic'},
	{id: 387,name: 'turtwig',type: 'grass'},
	{id: 388,name: 'grotle',type: 'grass'},
	{id: 389,name: 'torterra',type: 'ground, grass'},
	{id: 390,name: 'chimchar',type: 'fire'},
	{id: 391,name: 'monferno',type: 'fighting, fire'},
	{id: 392,name: 'infernape',type: 'fighting, fire'},
	{id: 393,name: 'piplup',type: 'water'},
	{id: 394,name: 'prinplup',type: 'water'},
	{id: 395,name: 'empoleon',type: 'steel, water'},
	...
	{id: 406,name: 'budew',type: 'poison, grass'},
	{id: 407,name: 'roserade',type: 'poison, grass'},
	...
	{id: 414,name: 'mothim',type: 'flying, bug'},
	{id: 415,name: 'combee',type: 'flying, bug'},
	{id: 416,name: 'vespiquen',type: 'flying, bug'},
	...
	{id: 423,name: 'gastrodon',type: 'ground, water'},
	{id: 424,name: 'ambipom',type: 'normal'},
	{id: 425,name: 'drifloon',type: 'flying, ghost'},
	{id: 426,name: 'drifblim',type: 'flying, ghost'},
	{id: 427,name: 'buneary',type: 'normal'},
	{id: 428,name: 'lopunny',type: 'normal'},
	{id: 429,name: 'mismagius',type: 'ghost'},
	{id: 430,name: 'honchkrow',type: 'flying, dark'},
	...
	{id: 443,name: 'gible',type: 'ground, dragon'},
	{id: 444,name: 'gabite',type: 'ground, dragon'},
	{id: 445,name: 'garchomp',type: 'ground, dragon'},
	...
	{id: 453,name: 'croagunk',type: 'fighting, poison'},
	{id: 454,name: 'toxicroak',type: 'fighting, poison'},
	{id: 455,name: 'carnivine',type: 'grass'},
	{id: 456,name: 'finneon',type: 'water'},
	{id: 457,name: 'lumineon',type: 'water'},
	{id: 458,name: 'mantyke',type: 'flying, water'},
	{id: 459,name: 'snover',type: 'grass, ice'},
	{id: 460,name: 'abomasnow',type: 'grass, ice'},
	{id: 461,name: 'weavile',type: 'ice, dark'},
	{id: 462,name: 'magnezone',type: 'steel, electric'},
	...
	{id: 468,name: 'togekiss',type: 'flying, fairy'},
	{id: 469,name: 'yanmega',type: 'flying, bug'},
	{id: 470,name: 'leafeon',type: 'grass'},
	{id: 471,name: 'glaceon',type: 'ice'},
	{id: 472,name: 'gliscor',type: 'flying, ground'},
	{id: 473,name: 'mamoswine',type: 'ground, ice'},
	{id: 475,name: 'gallade',type: 'fighting, psychic'},
	{id: 476,name: 'probopass',type: 'rock, steel'},
	{id: 477,name: 'dusknoir',type: 'ghost'},
	{id: 478,name: 'froslass',type: 'ghost, ice'},
	{id: 479,name: 'rotom',type: 'ghost, electric'},
	...
	{id: 485,name: 'heatran',type: 'steel, fire'},
...
document.onkeyup = function(event) {
	...
	// Check if a word is currently in progress
	if (word.length > 0) {
	...
	// If a word isn't in progress, keypress begins one.
	} else {
		roundReset();
	}
};
