...
var toggleAudio = function() {
    if (sound === true) {
    	sound = false;
    	document.getElementById('toggle-audio').innerHTML='Sound: Off';
    } else {
    	sound = true;
    	document.getElementById('toggle-audio').innerHTML='Sound: On';
    }
};
