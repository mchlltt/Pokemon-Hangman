...
function roundReset() {
	...
	document.getElementById('remaining').innerHTML='<p>Number of Guesses Remaining: ' + (letters.length - guesses) + '</p>';
...
function winBehavior() {
	...
	document.getElementById('image').innerHTML='<img src="assets/images/sprites/' + id + '.png" alt="Picture of '+ word + '">';
	wins++;
}
